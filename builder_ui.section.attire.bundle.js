...
(function(){
  ...
  const SETS = [
    ...
    // China / Eastern (7)
    {ja:"攻めチャイナ・雪羽スリット", en:"Bold Cheongsam Snow", tag: SHIMA_BRAND_CORE + ", " + "bold cheongsam dress, Shima-enaga motif, white silk, feather embroidery, high slit, icy jewelry"},
    {ja:"攻めチャイナ・サイバー氷龍", en:"Cyber Cheongsam", tag: SHIMA_BRAND_CORE + ", " + "cyber cheongsam, Shima-enaga motif, neon ice-blue circuits, feather patterns, futuristic accessories"},
    ...
    // Gravure / Glam (7)
    {ja:"グラビア・フェザー水着", en:"Feather Swimsuit", tag: SHIMA_BRAND_CORE + ", " + "gravure idol costume, Shima-enaga motif swimsuit, white and ice-blue, feather frills, glossy"},
    {ja:"グラビア・ビキニ雪結晶", en:"Snowflake Bikini", tag: SHIMA_BRAND_CORE + ", " + "Shima-enaga snowflake bikini, feather accessories, sparkling ice crystals, beach winter fantasy"},
    {ja:"グラビア・ランジェリー羽紋", en:"Feather Lingerie", tag: SHIMA_BRAND_CORE + ", " + "Shima-enaga motif lingerie set, white lace like feathers, delicate snowflake charms"},
    {ja:"グラビア・ボディスーツ艶", en:"Gloss Bodysuit", tag: SHIMA_BRAND_CORE + ", " + "Shima-enaga glossy bodysuit, feather pattern, sleek silhouette, high-fashion gravure"},
    {ja:"グラビア・ファーコート脱ぎかけ", en:"Half-Off Fur Coat", tag: SHIMA_BRAND_CORE + ", " + "Shima-enaga fur coat, feather trim, glamorous pose, teasing fashion (non-explicit)"},
    {ja:"グラビア・ナイトクラブドレス", en:"Night Club Dress", tag: SHIMA_BRAND_CORE + ", " + "Shima-enaga night club mini dress, feather boa, neon lighting, glam"},
    {ja:"グラビア・撮影会セット", en:"Photoshoot Set", tag: SHIMA_BRAND_CORE + ", " + "Shima-enaga gravure photoshoot outfit, studio lights, feather props, glossy makeup"},
    ...
    {ja:"攻めスペシャル・サテン深スリット", en:"Spicy Special Satin Deep Slit", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "satin gown, deep slit, glossy drape, elegant glam, refined silhouette"},
    {ja:"攻めスペシャル・ベルベット夜会", en:"Spicy Special Velvet Gala", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "velvet evening dress, soft sheen, luxe texture, cinematic night glam"},
    {ja:"攻めスペシャル・クリスタル縁ビスチェ", en:"Spicy Special Crystal Bustier", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "crystal-trim bustier, structured fit, jewel accents, high-fashion glam"},
    {ja:"攻めスペシャル・シルクホルター艶", en:"Spicy Special Silk Halter", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "silk halter dress, smooth fabric flow, flattering neckline, elegant shine"},
    {ja:"攻めスペシャル・レースマーメイド", en:"Spicy Special Lace Mermaid", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "lace mermaid dress, intricate lace, bodyline elegance, mature glam"},
    {ja:"攻めスペシャル・片肩グラム", en:"Spicy Special One-Shoulder", spicyGroup:"mode_bodycon", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "one-shoulder cocktail dress, asymmetric cut, sleek glam, modern silhouette"},
    {ja:"攻めスペシャル・オペラグローブ礼装", en:"Spicy Special Opera Gloves", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "opera gloves, gala styling, satin shine, classic luxury mood"},
    {ja:"攻めスペシャル・背中リボン背面魅せ", en:"Spicy Special Backless Ribbon", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "backless dress, ribbon back detail, elegant exposure, tasteful allure"},
    {ja:"攻めスペシャル・真珠チェーン背中飾り", en:"Spicy Special Pearl Chain", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "pearl chain back accessory, luxe sparkle, refined detailing"},
    {ja:"攻めスペシャル・透けレイヤー正装", en:"Spicy Special Sheer Overlay", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "sheer overlay layers, subtle translucency, light-catching fabric, elegant glam"},
    {ja:"攻めスペシャル・ネオン艶ボディコン", en:"Spicy Special Neon Bodycon", spicyGroup:"mode_bodycon", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "neon shimmer bodycon, nightclub glow, sleek fit, city night vibe"},
    {ja:"攻めスペシャル・ルーフトップ風スリット", en:"Spicy Special Rooftop Slit", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "wind-slit skirt, rooftop night, dynamic hem, dramatic silhouette"},
    {ja:"攻めスペシャル・反射素材シティナイト", en:"Spicy Special Reflective Night", spicyGroup:"mode_bodycon", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "reflective fabric accents, city lights, glossy highlights, modern glam"},
    {ja:"攻めスペシャル・月光シースルーカーデ", en:"Spicy Special Moonlit Cardigan", spicyGroup:"outer_gloss", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "moonlit sheer cardigan, soft translucency, gentle drape, night elegance"},
    {ja:"攻めスペシャル・スポットライト礼装スーツ", en:"Spicy Special Spotlight Suit", spicyGroup:"suit_formal", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "spotlight glam suit, tailored lines, stage-ready shine, confident presence"},
    {ja:"攻めスペシャル・ホログラムミニドレス", en:"Spicy Special Holo Mini", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "holographic mini dress, prism sheen, edgy glam, club fashion"},
    {ja:"攻めスペシャル・雨夜グロスレザー", en:"Spicy Special Rain Gloss", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "gloss leather look, rainy night reflections, sharp highlights, urban edge"},
    {ja:"攻めスペシャル・夜景ベルベットジャケット", en:"Spicy Special Velvet Jacket", spicyGroup:"suit_formal", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "velvet jacket styling, skyline night, luxe texture, chic layering"},
    {ja:"攻めスペシャル・プリズムクラブドレス", en:"Spicy Special Prism Club", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "prism shimmer club dress, luminous gradients, vivid nightlife glow"},
    {ja:"攻めスペシャル・シルエットロングコート艶", en:"Spicy Special Long Coat", spicyGroup:"outer_gloss", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "sleek long coat dress, slit detail, silhouette emphasis, night chic"},
    {ja:"攻めスペシャル・ゴシックレース深V", en:"Spicy Special Gothic Lace", spicyGroup:"leather_goth", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "gothic lace deep v, dark elegance, lace detail, dramatic glam"},
    {ja:"攻めスペシャル・ブラックサテンコルセット", en:"Spicy Special Satin Corset", spicyGroup:"leather_goth", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "black satin corset set, structured waist, luxurious sheen, bold glam"},
    {ja:"攻めスペシャル・黒薔薇シマー", en:"Spicy Special Black Rose", spicyGroup:"leather_goth", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "black rose accents, shimmer fabric, dark romantic glam"},
    {ja:"攻めスペシャル・影スリットレイヤード", en:"Spicy Special Shadow Slit", spicyGroup:"glam_dress", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "layered dress, shadow slit, subtle exposure, cinematic contrast"},
    {ja:"攻めスペシャル・紅差しダークグラム", en:"Spicy Special Crimson Accent", spicyGroup:"leather_goth", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "crimson accent details, dark glam palette, striking contrast"},
    {ja:"攻めスペシャル・構築モード輪郭セット", en:"Spicy Special Structured Mode", spicyGroup:"mode_bodycon", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "structured high-fashion set, contour lines, modern cut, runway vibe"},
    {ja:"攻めスペシャル・彫刻肩モードトップ", en:"Spicy Special Sculpted Shoulder", spicyGroup:"mode_bodycon", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "sculpted shoulder top, sharp silhouette, fashion-forward glam"},
    {ja:"攻めスペシャル・ハイウエスト光沢パンツ", en:"Spicy Special Gloss Trousers", spicyGroup:"mode_bodycon", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "high-waist gloss trousers, sleek tailoring, reflective finish, chic"},
    {ja:"攻めスペシャル・ミニマルシルクスーツ", en:"Spicy Special Minimal Silk", spicyGroup:"suit_formal", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "minimal silk suit, clean lines, subtle shine, refined presence"},
    {ja:"攻めスペシャル・スリットコートドレス", en:"Spicy Special Coat Dress", spicyGroup:"outer_gloss", group:"spicy", label:"SPICY", tag: SHIMA_BRAND_CORE + ", " + "coat dress with slit, modern minimal glam, elegant cut"},
  
  { ja:"攻めスペシャル・ダークベルベットスリップ", en:"Spicy Special Dark Velvet Slip", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "black velvet slip dress, subtle sheen, lace trim, night glamour" },
  { ja:"攻めスペシャル・漆黒レースボディスーツ", en:"Spicy Special Obsidian Lace Bodysuit", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "black lace bodysuit, sheer panels, elegant sensuality" },
  { ja:"攻めスペシャル・黒薔薇コルセット", en:"Spicy Special Black Rose Corset", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "corset with black rose embroidery, satin ribbons, hourglass silhouette" },
  { ja:"攻めスペシャル・スモークシフォンガウン", en:"Spicy Special Smoke Chiffon Gown", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "smoky chiffon gown, translucent layers, floating hem, moody lighting" },
  { ja:"攻めスペシャル・ダークサテンローブ", en:"Spicy Special Dark Satin Robe", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "dark satin robe, glossy drape, deep neckline, luxe loungewear" },
  { ja:"攻めスペシャル・影羽ケープドレス", en:"Spicy Special Shadow Feather Cape Dress", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "cape dress, feather-like gradient cape, dramatic silhouette, noir glamour" },
  { ja:"攻めスペシャル・月影シアードレス", en:"Spicy Special Moonshadow Sheer Dress", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "sheer dress, layered mesh, moonlit shimmer, elegant conceal-reveal" },
  { ja:"攻めスペシャル・黒曜スリットドレス", en:"Spicy Special Obsidian Slit Dress", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "high slit dress, obsidian shine, sleek lines, confident stance" },
  { ja:"攻めスペシャル・ダークグロススカートスーツ", en:"Spicy Special Dark Gloss Skirt Suit", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "glossy skirt suit, sharp shoulders, noir chic, subtle sparkle" },
  { ja:"攻めスペシャル・黒金ハーネスドレス", en:"Spicy Special Black-Gold Harness Dress", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "black and gold harness accents, elegant dress, refined edgy" },
  { ja:"攻めスペシャル・夜霧ネグリジェ", en:"Spicy Special Nightmist Negligee", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "negligee, soft lace, misty translucence, romantic noir" },
  { ja:"攻めスペシャル・黒真珠チョーカードレス", en:"Spicy Special Black Pearl Choker Dress", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "dress with black pearl choker collar, glossy fabric, elegant" },
  { ja:"攻めスペシャル・ダークレザータイトワンピ", en:"Spicy Special Dark Leather Bodycon", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "dark leather bodycon dress, matte+gloss contrast, sleek" },
  { ja:"攻めスペシャル・影織りロンググローブ", en:"Spicy Special Shadow-Weave Long Gloves", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "opera gloves, sheer pattern, shadow motif, classy allure" },
  { ja:"攻めスペシャル・暗紅シルクチャイナ", en:"Spicy Special Deep Crimson Silk Cheongsam", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "deep crimson silk cheongsam, black lace edging, sultry elegance" },
  { ja:"攻めスペシャル・漆黒ベールヘッドピース", en:"Spicy Special Obsidian Veil Headpiece", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "black veil headpiece, subtle sparkle, gothic chic" },
  { ja:"攻めスペシャル・ダークスパンコールミニ", en:"Spicy Special Dark Sequin Mini", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "dark sequin mini dress, shimmer, stage-ready glamour" },
  { ja:"攻めスペシャル・黒影オフショルドレス", en:"Spicy Special Noir Off-Shoulder Dress", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "off-shoulder dress, soft drape, noir elegance, collarbone highlight" },
  { ja:"攻めスペシャル・夜光タトゥーストッキング", en:"Spicy Special Nightglow Tattoo Stockings", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "patterned stockings, tattoo-like motifs, faint glow, stylish" },
  { ja:"攻めスペシャル・黒煙フードマント", en:"Spicy Special Black Smoke Hooded Mantle", group:"spicy", label:"SPICY", spicyGroup:"dark_glam", tag: SHIMA_BRAND_CORE + ", " + "hooded mantle, smoky gradient, cinematic silhouette, mysterious" },
  { ja:"攻めスペシャル・高級ビキニ雪結晶", en:"Spicy Special Luxury Bikini Snowflake", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "luxury bikini, ice-blue, snowflake charm, glossy fabric" },
  { ja:"攻めスペシャル・高級ワンピース水着シルク", en:"Spicy Special Luxury One-piece Silk Swim", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "one-piece swimsuit, silk-like sheen, minimal cut, premium" },
  { ja:"攻めスペシャル・高級ラッシュガード艶", en:"Spicy Special Glossy Rash Guard", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "glossy rash guard, feather stripe lines, sleek sport glam" },
  { ja:"攻めスペシャル・高級ビキニ羽根ライン", en:"Spicy Special Feather-Line Luxury Bikini", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "bikini, feather line accents, refined, high-end resort" },
  { ja:"攻めスペシャル・高級モノキニ宝石", en:"Spicy Special Jewel Monokini", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "monokini with jewel connector, reflective, couture swim" },
  { ja:"攻めスペシャル・高級シアーパレオ", en:"Spicy Special Sheer Pareo", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "sheer pareo wrap, translucent shimmer, elegant beachwear" },
  { ja:"攻めスペシャル・高級ビーチガウン", en:"Spicy Special Luxury Beach Gown", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "beach gown, flowing chiffon, subtle glitter, premium resort" },
  { ja:"攻めスペシャル・高級ハイウエスト水着", en:"Spicy Special High-Waist Luxury Swim", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "high-waist bikini, sculpted lines, satin gloss, classy" },
  { ja:"攻めスペシャル・高級水着ボンデージライン", en:"Spicy Special Couture Strapline Swim", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "couture swimwear, strapline detailing, tasteful edgy" },
  { ja:"攻めスペシャル・高級スイムキャップ羽チャーム", en:"Spicy Special Swim Cap Feather Charm", group:"spicy", label:"SPICY", spicyGroup:"luxury_swim", tag: SHIMA_BRAND_CORE + ", " + "swim cap, feather charm, polished sporty luxury" },
  { ja:"攻めスペシャル・ハイブランドボディコン", en:"Spicy Special High-Brand Bodycon", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "designer bodycon, clean cut, premium fabric, runway vibe" },
  { ja:"攻めスペシャル・ハイブランドシルクブラウス", en:"Spicy Special Designer Silk Blouse", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "silk blouse, subtle sheen, tailored cuffs, luxury" },
  { ja:"攻めスペシャル・ハイブランドペンシルスカート", en:"Spicy Special Designer Pencil Skirt", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "pencil skirt, precise tailoring, high-end minimal" },
  { ja:"攻めスペシャル・ハイブランドトレンチ艶", en:"Spicy Special Designer Gloss Trench", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "gloss trench coat, belt cinch, modern luxury" },
  { ja:"攻めスペシャル・ハイブランドカットアウトドレス", en:"Spicy Special Designer Cutout Dress", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "cutout dress, tasteful geometry, couture minimal" },
  { ja:"攻めスペシャル・ハイブランドレザースカート", en:"Spicy Special Designer Leather Skirt", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "leather skirt, matte-gloss mix, chic" },
  { ja:"攻めスペシャル・ハイブランドジャケットミニ", en:"Spicy Special Designer Jacket Mini", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "cropped jacket, mini dress layering, runway styling" },
  { ja:"攻めスペシャル・ハイブランドストラップヒール", en:"Spicy Special Designer Strap Heels", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "strap heels, metallic accent, high fashion" },
  { ja:"攻めスペシャル・ハイブランドシアートップス", en:"Spicy Special Designer Sheer Top", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "sheer top, fine mesh, luxury layering, elegant" },
  { ja:"攻めスペシャル・ハイブランドグローブバッグ", en:"Spicy Special Designer Glove & Bag", group:"spicy", label:"SPICY", spicyGroup:"highbrand_mode", tag: SHIMA_BRAND_CORE + ", " + "long gloves and mini bag, logo-less luxury, refined" },
  { ja:"攻めスペシャル・異世界艶サイバー魔装", en:"Spicy Special Cyber Arcane Glam Armor", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "cyber arcane armor, glowing runes, sleek plating, sensual silhouette" },
  { ja:"攻めスペシャル・異世界艶ナノスーツ", en:"Spicy Special Futuristic Nano Suit", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "futuristic nano suit, reflective, body-hugging, luminous seams" },
  { ja:"攻めスペシャル・異世界艶魔導スーツ", en:"Spicy Special Arcane Suit", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "arcane suit, magic circuits, glossy fabric, mystic tech" },
  { ja:"攻めスペシャル・異世界艶星屑マント", en:"Spicy Special Stardust Cape", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "stardust cape, floating particles, dramatic, otherworldly" },
  { ja:"攻めスペシャル・異世界艶ホログラムドレス", en:"Spicy Special Hologram Dress", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "hologram dress, shifting iridescence, sci-fi couture" },
  { ja:"攻めスペシャル・異世界艶魔装ボディスーツ", en:"Spicy Special Enchanted Bodysuit", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "enchanted bodysuit, rune patterns, sleek armor joints" },
  { ja:"攻めスペシャル・異世界艶ウィングユニット", en:"Spicy Special Wing Unit Harness", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "back-mounted wing unit, slim harness, energy feathers" },
  { ja:"攻めスペシャル・異世界艶プラズマコート", en:"Spicy Special Plasma Coat", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "plasma-lined coat, glowing edges, futuristic glam" },
  { ja:"攻めスペシャル・異世界艶光剣ホルスター", en:"Spicy Special Lightblade Holster", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "lightblade holster accessory, sleek belts, sci-fi fantasy" },
  { ja:"攻めスペシャル・異世界艶魔晶アクセ", en:"Spicy Special Magic Crystal Accessories", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "magic crystals, floating shards, elegant sparkle" },
  { ja:"攻めスペシャル・異世界艶戦術ドレスアーマー", en:"Spicy Special Tactical Dress Armor", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "dress armor hybrid, armored bodice, flowing skirt panels" },
  { ja:"攻めスペシャル・異世界艶月光ヘルム", en:"Spicy Special Moonlight Helm", group:"spicy", label:"SPICY", spicyGroup:"isekai_glam", tag: SHIMA_BRAND_CORE + ", " + "moonlight helm, open-face, elegant, luminous" },
  { ja:"ナイトクラブ艶・ネオン透過ドレス", en:"Nightclub Glam Neon Sheer Dress", tag: SHIMA_BRAND_CORE + ", " + "nightclub neon sheer dress, translucent panels, neon edge piping, glow trim, sleek nightlife silhouette", group:"spicy", label:"SPICY", spicyGroup:"nightclub_glam" },
  { ja:"ナイトクラブ艶・メタリックボディスーツ", en:"Nightclub Glam Metallic Bodysuit", tag: SHIMA_BRAND_CORE + ", " + "metallic glossy bodysuit, reflective chrome fabric, club lighting shine, sculpted silhouette", group:"spicy", label:"SPICY", spicyGroup:"nightclub_glam" },
  { ja:"ナイトクラブ艶・リキッドラメスリットドレス", en:"Nightclub Glam Liquid Glitter Slit Dress", tag: SHIMA_BRAND_CORE + ", " + "liquid glitter dress, wet-look shimmer, high slit, glossy highlights, nightclub vibe", group:"spicy", label:"SPICY", spicyGroup:"nightclub_glam" },
  { ja:"ナイトクラブ艶・レーザーカットジャケット", en:"Nightclub Glam Laser-Cut Jacket", tag: SHIMA_BRAND_CORE + ", " + "laser-cut short jacket, geometric cutouts, neon underglow, nightlife styling", group:"spicy", label:"SPICY", spicyGroup:"nightclub_glam" },
  { ja:"ナイトクラブ艶・ネオンハーネスセット", en:"Nightclub Glam Neon Harness Set", tag: SHIMA_BRAND_CORE + ", " + "neon harness accessories over sleek outfit, minimal straps, luminous accents, clubwear", group:"spicy", label:"SPICY", spicyGroup:"nightclub_glam" },,
  { ja:"和艶・高級・黒振袖スリット", en:"Waglam Luxury Black Furisode Slit", tag: SHIMA_BRAND_CORE + ", " + "black furisode with daring slit, luxurious silk sheen, elegant drape", group:"spicy", label:"SPICY", spicyGroup:"wa_lux_glam" },
  { ja:"和艶・高級・金箔羽織", en:"Waglam Luxury Gold Leaf Haori", tag: SHIMA_BRAND_CORE + ", " + "gold leaf haori, gilded patterns, opulent shimmer, refined layering", group:"spicy", label:"SPICY", spicyGroup:"wa_lux_glam" },
  { ja:"和艶・高級・漆塗り質感帯", en:"Waglam Luxury Lacquer Obi Texture", tag: SHIMA_BRAND_CORE + ", " + "lacquered obi texture, glossy urushi finish, deep reflective shine", group:"spicy", label:"SPICY", spicyGroup:"wa_lux_glam" },
  { ja:"和艶・高級・金襴刺繍の襟元", en:"Waglam Luxury Kinran Embroidered Collar", tag: SHIMA_BRAND_CORE + ", " + "kinran brocade embroidery, gold thread collar, premium detail", group:"spicy", label:"SPICY", spicyGroup:"wa_lux_glam" },
  { ja:"和艶・高級・簪と艶髪", en:"Waglam Luxury Kanzashi & Gloss Hair", tag: SHIMA_BRAND_CORE + ", " + "kanzashi hairpin, glossy black hair, elegant shine, high-end finish", group:"spicy", label:"SPICY", spicyGroup:"wa_lux_glam" },

  { ja:"未来ランウェイ艶・ホログラム布コート", en:"Future Runway Glam Hologram Coat", tag: SHIMA_BRAND_CORE + ", " + "holographic fabric long coat, shifting iridescence, runway silhouette, premium sheen", group:"spicy", label:"SPICY", spicyGroup:"futuristic_runway_glam" },
  { ja:"未来ランウェイ艶・半透明ハイブランドスーツ", en:"Future Runway Glam Translucent Luxury Suit", tag: SHIMA_BRAND_CORE + ", " + "semi-transparent luxury suit, layered sheer panels, high-fashion cut, glossy finish", group:"spicy", label:"SPICY", spicyGroup:"futuristic_runway_glam" },
  { ja:"未来ランウェイ艶・光沢アシンメトリードレス", en:"Future Runway Glam Glossy Asymmetric Dress", tag: SHIMA_BRAND_CORE + ", " + "glossy asymmetric dress, sharp couture lines, reflective highlights, runway drama", group:"spicy", label:"SPICY", spicyGroup:"futuristic_runway_glam" },
  { ja:"未来ランウェイ艶・LEDステッチドレス", en:"Future Runway Glam LED Stitch Dress", tag: SHIMA_BRAND_CORE + ", " + "LED stitch accents, luminous seams, minimalist couture, futuristic runway styling", group:"spicy", label:"SPICY", spicyGroup:"futuristic_runway_glam" },
  { ja:"未来ランウェイ艶・クリア素材ヒールブーツ", en:"Future Runway Glam Clear Heel Boots", tag: SHIMA_BRAND_CORE + ", " + "clear material high-heel boots, transparent gloss, designer runway accessory", group:"spicy", label:"SPICY", spicyGroup:"futuristic_runway_glam" },
  { ja:"冷艶・氷結スリットドレス", en:"Cold Glam Frozen Slit Dress", tag: SHIMA_BRAND_CORE + ", " + "ice-themed slit dress, frosted gloss, cold shimmer, crystalline highlights", group:"spicy", label:"SPICY", spicyGroup:"cold_glam" },
  { ja:"冷艶・結晶ビキニ", en:"Cold Glam Crystal Bikini", tag: SHIMA_BRAND_CORE + ", " + "crystal bikini, snowflake facets, icy shine, sparkling frost accents", group:"spicy", label:"SPICY", spicyGroup:"cold_glam" },
  { ja:"冷艶・冷光スーツ", en:"Cold Glam Cold-Light Suit", tag: SHIMA_BRAND_CORE + ", " + "cold light suit, pale luminous trim, sleek glossy fabric, winter glow", group:"spicy", label:"SPICY", spicyGroup:"cold_glam" },
  { ja:"冷艶・霜羽ケープ", en:"Cold Glam Frost Feather Cape", tag: SHIMA_BRAND_CORE + ", " + "frost feather cape, translucent feather layers, icy sheen, winter glamour", group:"spicy", label:"SPICY", spicyGroup:"cold_glam" },
  { ja:"冷艶・氷霧ボディコン", en:"Cold Glam Ice-Mist Bodycon", tag: SHIMA_BRAND_CORE + ", " + "bodycon dress with ice-mist gradient, glossy finish, chilled aura, sleek silhouette", group:"spicy", label:"SPICY", spicyGroup:"cold_glam" },
];
