...
const subBase = window.__QP_UTILS.createSubAccordion("✨ 画質・クオリティ (Base)", BASE_QUALITY);
      ...
      if (IS_GLOSS_UNLOCKED) {
        subHighEndContent.appendChild(window.__QP_UTILS.createSubAccordion("㊙️ 管理者専用モード (Admin Mode)", HIGH_END_GROUPS.secret, "secret"));
      }
