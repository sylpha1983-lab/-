(function(){
  ...
  const CATEGORIES = {
    ...
    "ファッションスタイル (Fashion Styles)": [
      ...
      { ja: "コテージコア (田園風)", en: "cottagecore" }, { ja: "ダークアカデミア", en: "dark academia" },
      { ja: "ヴェイパーウェイヴ", en: "vaporwave style" }, { ja: "サイバーファッション", en: "cyber fashion" },
    ...
    "年代・歴史ファッション (Historical/Decades)": [ // ★ 検索拡張
      { ja: "大正ロマン", en: "taisho roman" }, { ja: "昭和レトロ", en: "showa retro" },
      { ja: "ヴィクトリア朝", en: "victorian style" }, { ja: "1920s フラッパー", en: "1920s flapper dress" },
      { ja: "1950s ロカビリー", en: "1950s rockabilly" }, { ja: "80年代風", en: "80s style" },
      { ja: "トーガ (古代ローマ)", en: "toga" }, { ja: "キルト (スコットランド)", en: "kilt" },
    ...
    "世界観・民族衣装 (World/Traditional)": [
      ...
      { ja: "漢服", en: "hanfu" }, { ja: "チャイナドレス", en: "cheongsam" },
    ...
    "現代・トップス (Modern Tops)": [
      ...
      { ja: "白シャツ", en: "white shirt" }, { ja: "ワイシャツ", en: "dress shirt" },
      { ja: "パーカー", en: "hoodie" }, { ja: "セーター", en: "sweater" },
      { ja: "タートルネック", en: "turtleneck" }, { ja: "ニット", en: "ribbed sweater" },
      { ja: "タンクトップ", en: "tank top" }, { ja: "キャミソール", en: "camisole" },
      { ja: "ベアトップ/チューブトップ", en: "tube top" }, { ja: "オフショルダー", en: "off-shoulder" },
    ...
    "アウター・コート (Outerwear & Coats)": [
      ...
      { ja: "ピーコート", en: "pea coat" }, { ja: "ダウンジャケット", en: "puffer jacket" },
      { ja: "スタジャン", en: "varsity jacket" }, { ja: "スカジャン", en: "sukajan" },
      { ja: "ライダースジャケット", en: "biker jacket" }, { ja: "ブレザー", en: "blazer" },
      { ja: "レインコート", en: "raincoat" }, { ja: "マント/ケープ", en: "cape" },
      { ja: "ファーコート", en: "fur coat" }
    ],
    "ボトムス・ワンピース (Bottoms/Dresses)": [
      { ja: "ジーンズ", en: "jeans" }, { ja: "デニムショーツ", en: "denim shorts" },
      { ja: "ショートパンツ", en: "shorts" }, { ja: "ホットパンツ", en: "hot pants" },
      { ja: "スカート", en: "skirt" }, { ja: "ミニスカート", en: "miniskirt" },
      { ja: "ロングスカート", en: "long skirt" }, { ja: "プリーツスカート", en: "pleated skirt" },
      { ja: "タイトスカート", en: "pencil skirt" }, { ja: "ジャンパースカート", en: "pinafore dress" },
      { ja: "ワンピース", en: "dress" }, { ja: "ニットワンピ", en: "sweater dress" },
      { ja: "サロペット", en: "overalls" }, { ja: "レギンス", en: "leggings" },
      { ja: "スパッツ", en: "bike shorts" }, { ja: "ブルマ", en: "bloomers" }
    ],
    ...
    "制服・職業 (Uniforms/Jobs)": [
      ...
      { ja: "メイド服", en: "maid apron" }, { ja: "フレンチメイド", en: "french maid" },
      { ja: "ナース服", en: "nurse uniform" }, { ja: "シスター", en: "nun habit" },
      { ja: "巫女服", en: "miko attire" }, { ja: "警察官", en: "police uniform" },
      ...
      { ja: "シェフ/コック", en: "chef uniform" }, { ja: "探偵", en: "detective attire" },
      { ja: "パイロット", en: "pilot suit" }, { ja: "宇宙飛行士", en: "astronaut suit" }
    ],
    "RPGクラス・ファンタジー (RPG Classes/Fantasy)": [ // ★ 検索拡張
      { ja: "魔法少女", en: "magical girl outfit" }, { ja: "悪役令嬢", en: "villainess dress" },
      { ja: "パラディン (聖騎士)", en: "paladin armor" }, { ja: "クレリック (聖職者)", en: "cleric robe" },
      { ja: "ドルイド (森)", en: "druid outfit" }, { ja: "ネクロマンサー", en: "necromancer robe" },
      { ja: "盗賊/ローグ", en: "rogue outfit" }, { ja: "モンク/武闘家", en: "monk outfit" },
      { ja: "踊り子", en: "dancer outfit" }, { ja: "吟遊詩人", en: "bard outfit" },
      { ja: "鎧/アーマー", en: "armor" }, { ja: "ビキニアーマー", en: "bikini armor" },
      { ja: "ローブ", en: "robe" }, { ja: "冒険者の服", en: "adventurer outfit" }
    ],
    "イベント・着ぐるみ (Events/Costumes)": [
      { ja: "サンタ衣装", en: "santa costume" }, { ja: "ハロウィン衣装", en: "halloween costume" },
      { ja: "忍者", en: "ninja" }, { ja: "くノ一", en: "kunoichi" },
      { ja: "着ぐるみ (パジャマ)", en: "kigurumi" }, { ja: "ウェディングドレス", en: "wedding dress" },
      { ja: "イブニングドレス", en: "evening gown" }, { ja: "戦隊スーツ", en: "sentai suit" },
    ...
    // === ディテール・素材（検索強化） ===
    "高度な素材・質感 (Advanced Materials)": [ // ★ 検索拡張
      { ja: "ホログラフィック", en: "holographic" }, { ja: "玉虫色 (イリディセント)", en: "iridescent" },
      { ja: "ベルベット", en: "velvet" }, { ja: "シルク", en: "silk" },
      { ja: "PVC (ビニール)", en: "pvc" }, { ja: "ラテックス", en: "latex" },
      { ja: "スパンコール", en: "sequins" }, { ja: "ファー (毛皮)", en: "fur trim" },
      { ja: "フェザー (羽毛)", en: "feathers" }, { ja: "メタリック", en: "metallic" },
