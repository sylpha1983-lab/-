(function(){
  ...
  function attemptMount() {
    const order = [
      ...
      // ★ 修正: visualsync のラベルを変更し、preview_sync を削除
      { id: "visualsync", label: "トーン補正 & プレビュー (Visual Sync)" },
      // { id: "preview_sync", label: "プレビュー" }, // ← 削除しました

      { id: "lighting", label: "照明 (Lighting)" },
      { id: "effect", label: "エフェクト (Effect)" },
      { id: "cinematic", label: "シネマティック (Cinematic)" },
      { id: "faith", label: "信仰 (Faith)" },
      { id: "presets", label: "プリセット (Presets)" }
    ];
